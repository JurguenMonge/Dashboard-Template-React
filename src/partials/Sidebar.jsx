    ...
    <div className="min-w-fit">
      ...
      >
        ...
        <div className="space-y-8">
          {/* Pages group */}
          <div>
            <h3 className="text-xs uppercase text-gray-500 dark:text-yellow-600 font-semibold pl-3">
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            <svg className={`shrink-0 fill-current ${pathname === "/" || pathname.includes("dashboard") ? 'text-gray-500' : 'text-gray-500 dark:text-gray-600'}`} xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                          ...
                          <div className="flex shrink-0 ml-2">
                            <svg className={`w-3 h-3 shrink-0 ml-1 fill-current text-gray-500 dark:text-gray-600 ${open && "rotate-180"}`} viewBox="0 0 12 12">
                        ...
                        <ul className={`pl-8 mt-1 ${!open && "hidden"}`}>
                          <li className="mb-1 last:mb-0">
                            <NavLink
                              ...
                              to="/"
                              className={({ isActive }) =>
                                "block transition duration-150 truncate " +(isActive ? "text-yellow-500" : "text-gray-500/90 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200")
                              }
                            >
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex flex-shrink-0 ml-2">
                      <span className="inline-flex items-center justify-center h-5 text-xs font-medium text-white bg-yellow-600 px-2 rounded">4</span>
                    </div>
                  </div>
                </NavLink>
              </li>
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
                        href="#0"
                        className={`block text-gray-800 dark:text-gray-400 truncate transition duration-150 ${open ? "" : "hover:text-gray-900 dark:hover:text-gray-200"}`}
                        onClick={(e) => {
                          e.preventDefault();
                          handleClick();
                          setSidebarExpanded(true);
